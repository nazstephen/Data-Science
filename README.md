...
| [SQL Project](https://github.com/nazstephen/Data-Science/tree/main/SQL%20Project) | You're working as an analyst for Zuber, a new ride-sharing company that's launching in Chicago. Your task is to find patterns in the available information. You want to understand passenger preferences and the impact of external factors on rides. | _requests, BeautifulSoup, pandas, matplotlib and scipy_ | [Intro to Machine Learning Project]() |  |  
